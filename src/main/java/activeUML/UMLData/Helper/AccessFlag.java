...
public class AccessFlag {
    ...
    public static boolean isStatic(int accflags) {
        return (accflags & STATIC) != 0;
    }
    
    public static boolean isFinal(int accflags) {
        return (accflags & FINAL) != 0;
    }
    
    public static boolean isAbstract(int accflags) {
        return (accflags & ABSTRACT) != 0;
    }
    
    public static boolean isAnnotation(int accflags) {
        return (accflags & ANNOTATION) != 0;
    }
    public static boolean isInterface(int accflags) {
        return (accflags & INTERFACE) != 0;
    }
